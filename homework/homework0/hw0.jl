...
student = (name = "Shivam Chitnis", kerberos_id = "shivamchitnis")
...
ex_1_1 = md"""
Case 1: $a^2>x \implies xa^2>x^2 \implies x>x^2/a^2 \implies a>\sqrt{x}>x/a$ \
Case 2: $a^2<x \implies xa^2<x^2 \implies x<x^2/a^2 \implies a<\sqrt{x}<x/a$
""" 
